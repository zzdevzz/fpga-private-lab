...
//               Basic Communication.gen/sources_1/bd/top/ip/top_I2C_OV7670_Master_0_0/top_I2C_OV7670_Master_0_0_stub.v}
...
module top_I2C_OV7670_Master_0_0(clk_100, reset, slave_reg_addr, slave_reg_data, 
  ov7670_SCL, sda_out, sda_in, sda_oe, shift_reg_debug, byte_counter_debug, bit_counter_debug, 
  shift_reg_full_debug, i2c_data_read, state_debug, simple_state_debug, ov7670_pwdn, 
  ov7670_reset)
/* synthesis syn_black_box black_box_pad_pin="reset,slave_reg_addr[7:0],slave_reg_data[7:0],ov7670_SCL,sda_out,sda_in,sda_oe,shift_reg_debug[7:0],byte_counter_debug[1:0],bit_counter_debug[3:0],shift_reg_full_debug[7:0],i2c_data_read[1:0],state_debug[2:0],simple_state_debug[3:0],ov7670_pwdn,ov7670_reset" */
