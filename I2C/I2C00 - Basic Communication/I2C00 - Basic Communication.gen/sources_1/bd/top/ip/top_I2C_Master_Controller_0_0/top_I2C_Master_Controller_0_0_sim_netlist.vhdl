...
architecture STRUCTURE of top_I2C_Master_Controller_0_0_I2C_Master_Controller is
  ...
  signal scl_rise16_out : STD_LOGIC;
  ...
  signal \simple_state_debug[3]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[6]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_6\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \bit_counter[3]_i_3\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \byte_counter[1]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of read_phase_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of read_register_sample_s_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of repeated_start_phase_i_1 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \scl_cnt[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \scl_cnt[8]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of scl_en_i_1 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of scl_fall_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of scl_i_2 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of sda_oe_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_oe_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of sda_out_s_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of sda_out_s_i_3 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \shift_reg_full[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \simple_state_debug[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \simple_state_debug[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_4\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \state_debug[3]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of write_register_pulse_i_2 : label is "soft_lutpair18";
begin
...
\FSM_onehot_state[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\FSM_onehot_state[9]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_state[9]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
read_register_sample_s_i_1: unisim.vcomponents.LUT6
    generic map(
...
read_register_sample_s_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\scl_cnt[8]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
scl_rise_i_2: unisim.vcomponents.LUT6
    generic map(
...
sda_oe_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\simple_state_debug[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\simple_state_debug[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\simple_state_debug[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
write_register_pulse_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
