...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  signal scl_fall16_out : STD_LOGIC;
  signal scl_fall_i_2_n_0 : STD_LOGIC;
  signal \^scl_fall_reg_0\ : STD_LOGIC;
  signal scl_high_safe_sample : STD_LOGIC;
  ...
  signal \simple_state_debug[3]_i_5_n_0\ : STD_LOGIC;
  ...
  signal write_register_nack_i_2_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[6]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_5\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \scl_cnt[2]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of scl_fall_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of scl_high_safe_sample_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of scl_high_safe_sample_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of scl_rise_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of scl_rise_i_3 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of sda_oe_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of sda_oe_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of sda_oe_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of sda_oe_i_8 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of sda_out_s_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \simple_state_debug[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_5\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \state_debug[0]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state_debug[1]_INST_0\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of write_register_nack_i_2 : label is "soft_lutpair2";
...
\FSM_onehot_state[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \simple_state_debug[3]_i_4_n_0\,
...
scl_rise_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00200000"
    )
        port map (
...
sda_oe_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
sda_oe_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAEA"
    )
        port map (
...
sda_oe_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\simple_state_debug[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\simple_state_debug[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \^q\(1),
      I1 => \FSM_onehot_state_reg_n_0_[4]\,
      I2 => \simple_state_debug[3]_i_5_n_0\,
      I3 => \^scl_fall_reg_0\,
      I4 => \^scl_rise_reg_0\,
      I5 => \^q\(0),
      O => \simple_state_debug[3]_i_4_n_0\
    );
\simple_state_debug[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => \^q\(2),
      I1 => \^q\(3),
      O => \simple_state_debug[3]_i_5_n_0\
    );
...
write_register_nack_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888F8880"
    )
        port map (
      ...
      I1 => sda_in,
      I2 => \FSM_onehot_state_reg_n_0_[9]\,
      I3 => write_register_nack_i_2_n_0,
      I4 => \^write_register_nack\,
      O => write_register_nack_i_1_n_0
    );
write_register_nack_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80888080"
    )
        port map (
...
write_register_pulse_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => read_enable_reg_n_0,
      I1 => \FSM_onehot_state_reg_n_0_[5]\,
      I2 => write_register_nack_i_2_n_0,
