...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \bit_counter[3]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of repeated_start_phase_i_1 : label is "soft_lutpair5";
...
\simple_state_debug[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF4"
    )
        port map (
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller
     port map (
      ...
      \state_reg[2]_0\(2 downto 0) => state_debug(2 downto 0)
    );
end STRUCTURE;
