...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_100, reset, slave_signal_sent, 
  ...
  sda_out, sda_in, sda_oe, read_register_sample, read_data, write_register_nack, 
  write_register_pulse, shift_reg_debug, byte_counter_debug, bit_counter_debug, 
...
/* synthesis syn_black_box black_box_pad_pin="reset,slave_signal_sent,slave_model_addr[7:0],slave_reg_addr[7:0],slave_reg_data[7:0],ov7670_SCL,SCL_RISE_EDGE,SCL_FALL_EDGE,sda_out,sda_in,sda_oe,read_register_sample,read_data[7:0],write_register_nack,write_register_pulse,shift_reg_debug[7:0],byte_counter_debug[1:0],bit_counter_debug[4:0],shift_reg_full_debug[7:0],current_index_bebug[2:0],scl_en_debug,i2c_data_read[1:0],state_debug[3:0],simple_state_debug[3:0],ov7670_pwdn,ov7670_reset" */
