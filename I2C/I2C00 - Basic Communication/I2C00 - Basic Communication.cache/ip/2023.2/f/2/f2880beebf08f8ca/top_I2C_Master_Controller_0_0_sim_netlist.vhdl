...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  signal scl_fall_i_3_n_0 : STD_LOGIC;
  ...
  signal scl_high_safe_sample_i_4_n_0 : STD_LOGIC;
  ...
  signal scl_rise_i_5_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \byte_counter[0]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \scl_cnt[1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \scl_cnt[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \scl_cnt[3]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \scl_cnt[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \scl_cnt[9]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of scl_en_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of scl_fall_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of scl_fall_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of scl_high_safe_sample_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of scl_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of scl_low_safe_sample_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of scl_rise_i_3 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of scl_rise_i_4 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sda_oe_i_5 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \shift_reg[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \simple_state_debug[0]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \state_debug[3]_INST_0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state_hold[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of write_register_pulse_i_2 : label is "soft_lutpair14";
begin
...
scl_fall_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
scl_fall_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
scl_high_safe_sample_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \^scl_en_reg_0\,
      I2 => scl_cnt_reg(8),
      I3 => scl_high_safe_sample_i_3_n_0,
      I4 => scl_rise_i_5_n_0,
      I5 => scl_low_safe_sample_i_2_n_0,
...
scl_high_safe_sample_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => scl_cnt_reg(0),
      I4 => scl_cnt_reg(1),
      I5 => scl_high_safe_sample_i_4_n_0,
      O => scl_high_safe_sample_i_2_n_0
    );
scl_high_safe_sample_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
scl_high_safe_sample_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFFFFFF"
    )
        port map (
      ...
      I3 => scl_cnt_reg(5),
      I4 => scl_cnt_reg(3),
      O => scl_high_safe_sample_i_4_n_0
    );
...
scl_low_safe_sample_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00202222"
    )
        port map (
...
scl_low_safe_sample_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000010000000"
    )
        port map (
      I0 => \scl_cnt[7]_i_2_n_0\,
      I1 => scl_cnt_reg(3),
      I2 => scl_cnt_reg(8),
      I3 => scl_cnt_reg(5),
      I4 => scl_cnt_reg(4),
...
scl_rise_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
scl_rise_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
sda_oe_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
