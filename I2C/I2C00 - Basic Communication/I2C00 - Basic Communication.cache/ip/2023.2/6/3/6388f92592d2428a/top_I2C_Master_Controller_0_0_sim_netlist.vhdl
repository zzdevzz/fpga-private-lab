...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  signal write_register_nack_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \scl_cnt[0]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[8]_i_3\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_4\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of write_register_nack_i_2 : label is "soft_lutpair1";
...
\FSM_onehot_state[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFEFEFE"
        ...
        port map (
      I0 => \FSM_onehot_state[9]_i_4_n_0\,
      I1 => \FSM_onehot_state_reg_n_0_[2]\,
...
write_register_nack_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ABA8"
        ...
        port map (
      I0 => write_register_nack_i_2_n_0,
      I1 => \FSM_onehot_state_reg_n_0_[9]\,
      I2 => write_register_nack_i_3_n_0,
...
write_register_nack_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88880080"
    )
        port map (
