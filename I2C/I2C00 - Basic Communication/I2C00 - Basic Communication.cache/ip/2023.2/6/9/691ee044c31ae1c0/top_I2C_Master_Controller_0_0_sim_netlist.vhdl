...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \bit_counter[3]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of scl_rise_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of scl_rise_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of sda_oe_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of sda_oe_i_3 : label is "soft_lutpair10";
...
\scl_cnt[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => scl_cnt_reg(5),
      I3 => scl_cnt_reg(3),
      I4 => scl_low_safe_sample_i_2_n_0,
      O => p_0_in(6)
    );
