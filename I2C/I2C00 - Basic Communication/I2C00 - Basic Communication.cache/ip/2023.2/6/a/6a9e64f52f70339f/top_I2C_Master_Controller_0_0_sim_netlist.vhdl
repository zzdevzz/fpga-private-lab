...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \bit_counter[3]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \bit_counter[3]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \bit_counter[3]_i_5\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of read_register_sample_s_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of read_register_sample_s_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of reset_activated_i_1 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[2]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of scl_low_safe_sample_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of scl_low_safe_sample_i_3 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of scl_rise_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of sda_oe_i_3 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of sda_oe_i_4 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sda_oe_i_5 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_oe_i_6 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of sda_out_s_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of sda_out_s_i_4 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sda_out_s_i_5 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \shift_reg[1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \simple_state_debug[0]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \simple_state_debug[2]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of start_setup_i_1 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \state_hold[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of write_register_pulse_i_2 : label is "soft_lutpair8";
begin
...
\bit_counter[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
scl_high_safe_sample_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => scl_cnt_reg(8),
      I4 => scl_cnt_reg(1),
      I5 => scl_low_safe_sample_i_1_n_0,
...
sda_oe_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C000A0A0"
    )
        port map (
...
sda_oe_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFC404"
    )
        port map (
...
sda_oe_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
sda_oe_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
sda_out_s_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => shift_reg,
      I2 => sda_out_s_i_3_n_0,
      I3 => sda_out_s_i_4_n_0,
...
sda_out_s_i_2: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \^shift_reg_full_debug\(7),
      I3 => \FSM_onehot_state_reg_n_0_[4]\,
      O => sda_out_s_i_2_n_0
    );
sda_out_s_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\simple_state_debug[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFAAEA"
        ...
        port map (
      I0 => \simple_state_debug[2]_i_2_n_0\,
...
\simple_state_debug[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\simple_state_debug[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \bit_counter[3]_i_3_n_0\,
      I1 => \FSM_onehot_state_reg_n_0_[5]\,
      I2 => \simple_state_debug[3]_i_2_n_0\,
