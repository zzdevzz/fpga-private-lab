...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_OV7670_Master is
  ...
  signal scl_cnt_reg : STD_LOGIC_VECTOR ( 9 downto 3 );
  signal \scl_cnt_reg_n_0_[0]\ : STD_LOGIC;
  signal \scl_cnt_reg_n_0_[1]\ : STD_LOGIC;
  signal \scl_cnt_reg_n_0_[2]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \scl_cnt[6]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[9]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of scl_en_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of scl_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of scl_rise_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of sda_out_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \shift_reg_full[6]_i_1\ : label is "soft_lutpair7";
...
\scl_cnt[9]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
