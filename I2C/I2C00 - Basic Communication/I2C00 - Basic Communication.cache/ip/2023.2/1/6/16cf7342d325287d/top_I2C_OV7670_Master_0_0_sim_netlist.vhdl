...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_OV7670_Master is
  ...
  signal reset_activated121_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bit_counter[3]_i_3\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \scl_cnt[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \scl_cnt[2]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \scl_cnt[8]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of scl_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of sda_oe_i_3 : label is "soft_lutpair3";
...
\scl_cnt[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
sda_oe_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
