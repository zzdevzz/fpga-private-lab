...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_6\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of repeated_start_phase_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of reset_activated_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \scl_cnt[0]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of sda_oe_i_11 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sda_oe_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_oe_i_4 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of sda_oe_i_8 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of sda_oe_i_9 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of sda_out_s_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of sda_out_s_i_3 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_2\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of write_register_nack_i_1 : label is "soft_lutpair8";
...
sda_oe_i_10: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
sda_oe_i_11: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
sda_oe_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
