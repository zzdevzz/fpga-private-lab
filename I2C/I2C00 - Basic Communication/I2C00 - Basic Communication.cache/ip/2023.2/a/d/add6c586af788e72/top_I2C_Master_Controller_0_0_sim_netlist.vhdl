...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[3]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \FSM_onehot_state[6]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_onehot_state[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_onehot_state[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of read_register_sample_s_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of reset_activated_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \scl_cnt[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \scl_cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \scl_cnt[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \scl_cnt[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \scl_cnt[6]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of scl_en_i_1 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of scl_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sda_oe_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of sda_oe_i_6 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_oe_i_8 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of sda_out_s_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \simple_state_debug[0]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_5\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \state_debug[1]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state_debug[2]_INST_0\ : label is "soft_lutpair13";
...
sda_oe_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
sda_oe_i_8: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C0008888"
    )
        port map (
...
\simple_state_debug[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \^scl_fall_reg_0\,
      I4 => \FSM_onehot_state_reg_n_0_[4]\,
      I5 => \simple_state_debug[3]_i_5_n_0\,
...
\simple_state_debug[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
