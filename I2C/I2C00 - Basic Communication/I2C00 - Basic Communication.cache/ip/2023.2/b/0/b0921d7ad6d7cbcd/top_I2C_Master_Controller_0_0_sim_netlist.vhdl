...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_5\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_7\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \bit_counter[2]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \bit_counter[3]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \bit_counter[3]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \bit_counter[3]_i_5\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of read_phase_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of read_register_sample_s_i_2 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[8]_i_2\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of sda_oe_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of sda_oe_i_4 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of sda_oe_i_5 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of sda_out_s_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of sda_out_s_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \simple_state_debug[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \simple_state_debug[3]_i_3\ : label is "soft_lutpair3";
...
\FSM_onehot_state[9]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
\FSM_onehot_state[9]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\bit_counter[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFBB101010101010"
    )
        port map (
      I0 => \^q\(3),
      I1 => \^q\(0),
      I2 => \FSM_onehot_state_reg_n_0_[8]\,
      I3 => sda_out_s_i_2_n_0,
      I4 => \^scl_fall_reg_0\,
...
\bit_counter[3]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
sda_oe_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\simple_state_debug[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => sda_oe_i_4_n_0,
      I5 => \simple_state_debug[3]_i_3_n_0\,
...
write_register_nack_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F80"
    )
        port map (
      ...
      I3 => \^write_register_nack\,
      O => write_register_nack_i_1_n_0
    );
write_register_nack_i_2: unisim.vcomponents.LUT6
    generic map(
