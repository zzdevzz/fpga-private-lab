...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_6\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \bit_counter[3]_i_4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of read_register_sample_s_i_2 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[7]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \scl_cnt[8]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of scl_rise_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sda_oe_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of sda_oe_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of sda_out_s_i_4 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of sda_out_s_i_5 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \simple_state_debug[1]_i_3\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of write_register_pulse_i_2 : label is "soft_lutpair13";
begin
...
read_register_sample_s_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\scl_cnt[8]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF4000"
    )
        port map (
...
sda_out_s_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"ECECFCCC"
    )
        port map (
...
sda_out_s_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
write_register_pulse_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF80"
    )
        port map (
