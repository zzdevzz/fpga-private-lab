...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Master_Controller is
  ...
  signal write_register_pulse_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[9]_i_5\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \scl_cnt[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \scl_cnt[1]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of sda_oe_i_7 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of sda_oe_i_8 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \state_debug[1]_INST_0\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of write_register_pulse_i_3 : label is "soft_lutpair3";
begin
...
write_register_pulse_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => write_register_pulse_i_3_n_0,
      I4 => \FSM_onehot_state_reg_n_0_[0]\,
...
write_register_pulse_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \FSM_onehot_state_reg_n_0_[9]\,
      I1 => \FSM_onehot_state_reg_n_0_[6]\,
      O => write_register_pulse_i_3_n_0
    );
