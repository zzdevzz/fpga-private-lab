...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_OV7670_Master is
  ...
  signal reset_activated113_out : STD_LOGIC;
  ...
  signal scl_rise11_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of reset_activated_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \scl_cnt[0]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of scl_fall_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sda_out_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of sda_out_i_4 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \state_debug[1]_INST_0\ : label is "soft_lutpair1";
...
sda_out_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
