...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output is
  ...
  signal bram_addr_s0 : STD_LOGIC_VECTOR ( 9 downto 4 );
  signal \bram_addr_s0_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \bram_addr_s0_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \bram_addr_s0_carry__0_n_3\ : STD_LOGIC;
  signal bram_addr_s0_carry_i_1_n_0 : STD_LOGIC;
  signal bram_addr_s0_carry_i_2_n_0 : STD_LOGIC;
  signal bram_addr_s0_carry_i_3_n_0 : STD_LOGIC;
  signal bram_addr_s0_carry_n_0 : STD_LOGIC;
  signal bram_addr_s0_carry_n_1 : STD_LOGIC;
  signal bram_addr_s0_carry_n_2 : STD_LOGIC;
  signal bram_addr_s0_carry_n_3 : STD_LOGIC;
  signal \bram_addr_s[9]_i_2_n_0\ : STD_LOGIC;
  signal \horiz_counter[0]_i_1_n_0\ : STD_LOGIC;
  signal horiz_counter_reg : STD_LOGIC_VECTOR ( 9 downto 4 );
  signal \horiz_counter_reg__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \NLW_bram_addr_s0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_bram_addr_s0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \R_out[3]_i_2\ : label is "soft_lutpair8";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of bram_addr_s0_carry : label is 35;
  attribute ADDER_THRESHOLD of \bram_addr_s0_carry__0\ : label is 35;
  attribute SOFT_HLUTNM of \bram_addr_s[9]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \horiz_counter[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \horiz_counter[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \horiz_counter[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \horiz_counter[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \horiz_counter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \horiz_counter[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \horiz_counter[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \horiz_counter[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \vert_counter[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \vert_counter[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vert_counter[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vert_counter[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vert_counter[4]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \vert_counter[8]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_6\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_7\ : label is "soft_lutpair2";
begin
...
bram_addr_s0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => bram_addr_s0_carry_n_0,
      CO(2) => bram_addr_s0_carry_n_1,
      CO(1) => bram_addr_s0_carry_n_2,
      CO(0) => bram_addr_s0_carry_n_3,
      CYINIT => '0',
      DI(3 downto 1) => vert_counter(2 downto 0),
      DI(0) => '0',
      O(3 downto 0) => bram_addr_s0(7 downto 4),
      S(3) => bram_addr_s0_carry_i_1_n_0,
      S(2) => bram_addr_s0_carry_i_2_n_0,
      S(1) => bram_addr_s0_carry_i_3_n_0,
      S(0) => horiz_counter_reg(4)
    );
\bram_addr_s0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => bram_addr_s0_carry_n_0,
      CO(3 downto 1) => \NLW_bram_addr_s0_carry__0_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \bram_addr_s0_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => vert_counter(3),
      O(3 downto 2) => \NLW_bram_addr_s0_carry__0_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => bram_addr_s0(9 downto 8),
      S(3 downto 2) => B"00",
      S(1) => \bram_addr_s0_carry__0_i_1_n_0\,
      S(0) => \bram_addr_s0_carry__0_i_2_n_0\
    );
\bram_addr_s0_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\bram_addr_s0_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
bram_addr_s0_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
bram_addr_s0_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
bram_addr_s0_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\bram_addr_s[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\bram_addr_s[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\vert_counter[9]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\vert_counter[9]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
