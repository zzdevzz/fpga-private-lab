...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output is
  ...
  attribute SOFT_HLUTNM of \vert_counter[9]_i_5\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_7\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \vert_counter[9]_i_8\ : label is "soft_lutpair2";
begin
...
\vert_counter[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => vert_counter(9),
      I2 => \vert_counter[9]_i_7_n_0\,
      I3 => vert_counter(1),
      I4 => \vert_counter[9]_i_8_n_0\,
...
\vert_counter[9]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\vert_counter[9]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
