...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output_Colour is
  ...
  signal horiz_counter1 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_26 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_28 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_29 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_30 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_32 : label is "soft_lutpair2";
...
bram_addr_s_reg_i_28: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output_Colour
     port map (
      ...
      clk => clk,
      pixel_capture_we => pixel_capture_we,
