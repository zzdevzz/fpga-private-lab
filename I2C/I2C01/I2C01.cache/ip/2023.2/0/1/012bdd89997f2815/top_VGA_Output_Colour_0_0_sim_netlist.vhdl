...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output_Colour is
  ...
  signal bram_addr_s_reg_i_18_n_0 : STD_LOGIC;
  signal bram_addr_s_reg_i_1_n_0 : STD_LOGIC;
  signal bram_addr_s_reg_i_20_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of Hp_out_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_26 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_27 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_28 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_32 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of re_out_i_1 : label is "soft_lutpair0";
begin
...
Hp_out_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
Hp_out_i_3: unisim.vcomponents.LUT6
    generic map(
...
Vp_out_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFF1FF"
    )
        port map (
...
bram_addr_s_reg: unisim.vcomponents.DSP48E1
    generic map(
      ...
      C(9 downto 7) => p_0_in(9 downto 7),
      C(6) => bram_addr_s_reg_i_18_n_0,
      C(5) => p_0_in(5),
      C(4) => bram_addr_s_reg_i_20_n_0,
      C(3 downto 0) => p_0_in(3 downto 0),
      CARRYCASCIN => '0',
...
bram_addr_s_reg_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2A80"
    )
        port map (
...
bram_addr_s_reg_i_13: unisim.vcomponents.LUT3
    generic map(
      INIT => X"28"
    )
        port map (
...
bram_addr_s_reg_i_25: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_s_reg_i_26: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
bram_addr_s_reg_i_27: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
bram_addr_s_reg_i_28: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
bram_addr_s_reg_i_29: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_s_reg_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
bram_addr_s_reg_i_30: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_s_reg_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8882"
    )
        port map (
...
current_pix_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"06"
    )
        port map (
