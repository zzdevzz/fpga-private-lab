...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Pixel_Capture is
  ...
  signal bram_addr_s1_carry_i_8_n_0 : STD_LOGIC;
  ...
  signal state_type : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute SOFT_HLUTNM of \state_type[0]_i_1\ : label is "soft_lutpair0";
...
bram_addr_s1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => bram_addr_s1_carry_i_1_n_0,
      DI(2) => bram_addr_s1_carry_i_2_n_0,
      DI(1) => bram_addr_s1_carry_i_3_n_0,
      DI(0) => bram_addr_s1_carry_i_4_n_0,
      O(3 downto 0) => NLW_bram_addr_s1_carry_O_UNCONNECTED(3 downto 0),
      S(3) => bram_addr_s1_carry_i_5_n_0,
      S(2) => bram_addr_s1_carry_i_6_n_0,
      S(1) => bram_addr_s1_carry_i_7_n_0,
      S(0) => bram_addr_s1_carry_i_8_n_0
    );
...
\bram_addr_s1_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
bram_addr_s1_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
bram_addr_s1_carry_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\bram_addr_s[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF20"
    )
        port map (
...
\bram_addr_s[11]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\state_type[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0B"
    )
        port map (
