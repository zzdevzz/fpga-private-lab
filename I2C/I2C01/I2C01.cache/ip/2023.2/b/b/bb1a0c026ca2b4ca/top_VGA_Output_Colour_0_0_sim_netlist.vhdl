...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output_Colour is
  ...
  signal bram_addr_s_reg_i_2_n_0 : STD_LOGIC;
  ...
  signal bram_addr_s_reg_i_33_n_0 : STD_LOGIC;
  signal bram_addr_s_reg_i_4_n_0 : STD_LOGIC;
  signal current_pix : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_25 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_27 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_30 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_31 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_32 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of bram_addr_s_reg_i_33 : label is "soft_lutpair1";
...
bram_addr_s_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => start_capture,
      I4 => bram_addr_s_reg_i_28_n_0,
      I5 => bram_addr_s_reg_i_29_n_0,
...
bram_addr_s_reg_i_13: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00FFBF00"
    )
        port map (
...
bram_addr_s_reg_i_14: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
bram_addr_s_reg_i_15: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_s_reg_i_16: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7F0080"
    )
        port map (
      ...
      I1 => horiz_counter_reg(6),
      I2 => horiz_counter_reg(5),
      I3 => bram_addr_s_reg_i_26_n_0,
      I4 => horiz_counter_reg(8),
      O => p_0_in(8)
    );
bram_addr_s_reg_i_17: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF40"
    )
        port map (
      I0 => bram_addr_s_reg_i_26_n_0,
      I1 => horiz_counter_reg(5),
      I2 => horiz_counter_reg(6),
      I3 => horiz_counter_reg(7),
      O => p_0_in(7)
    );
bram_addr_s_reg_i_18: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
bram_addr_s_reg_i_19: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_s_reg_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => start_capture,
      I1 => current_pix,
      O => bram_addr_s_reg_i_2_n_0
    );
bram_addr_s_reg_i_20: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
bram_addr_s_reg_i_21: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
bram_addr_s_reg_i_22: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
bram_addr_s_reg_i_23: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
bram_addr_s_reg_i_24: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
bram_addr_s_reg_i_25: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
bram_addr_s_reg_i_26: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
bram_addr_s_reg_i_27: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
bram_addr_s_reg_i_28: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_s_reg_i_29: unisim.vcomponents.LUT5
    generic map(
      INIT => X"40000000"
    )
        port map (
...
bram_addr_s_reg_i_30: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
bram_addr_s_reg_i_31: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
bram_addr_s_reg_i_32: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
bram_addr_s_reg_i_33: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
bram_addr_s_reg_i_8: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
bram_addr_s_reg_i_9: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFF80000000"
    )
        port map (
...
current_pix_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D5D555D52A2AAA2A"
    )
        port map (
      I0 => start_capture,
      I1 => horiz_counter_reg(9),
