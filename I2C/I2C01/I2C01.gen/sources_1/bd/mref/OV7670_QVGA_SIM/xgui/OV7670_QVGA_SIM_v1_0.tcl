...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "VBLANK_LINES" -parent ${Page_0}
...
proc update_PARAM_VALUE.VBLANK_LINES { PARAM_VALUE.VBLANK_LINES } {
	# Procedure called to update VBLANK_LINES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.VBLANK_LINES { PARAM_VALUE.VBLANK_LINES } {
	# Procedure called to validate VBLANK_LINES
	return true
}
...
proc update_MODELPARAM_VALUE.VBLANK_LINES { MODELPARAM_VALUE.VBLANK_LINES PARAM_VALUE.VBLANK_LINES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.VBLANK_LINES}] ${MODELPARAM_VALUE.VBLANK_LINES}
}
