...
-- Command     : write_vhdl -force -mode funcsim -rename_top top_Pixel_Capture_0_0 -prefix
--               top_Pixel_Capture_0_0_ top_Pixel_Capture_0_0_sim_netlist.vhdl
...
entity top_Pixel_Capture_0_0_Pixel_Capture is
  port (
...
end top_Pixel_Capture_0_0_Pixel_Capture;

architecture STRUCTURE of top_Pixel_Capture_0_0_Pixel_Capture is
  ...
  attribute SOFT_HLUTNM of \state_type[1]_i_1\ : label is "soft_lutpair2";
...
\bram_addr_s[16]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
bram_enable_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
start_capture_flag_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AAEA"
    )
        port map (
...
\state_type[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\state_type[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\temp_reg[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
entity top_Pixel_Capture_0_0 is
  ...
  attribute NotValidForBitStream of top_Pixel_Capture_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_Pixel_Capture_0_0 : entity is "top_Pixel_Capture_0_0,Pixel_Capture,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of top_Pixel_Capture_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of top_Pixel_Capture_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of top_Pixel_Capture_0_0 : entity is "Pixel_Capture,Vivado 2023.2";
end top_Pixel_Capture_0_0;

architecture STRUCTURE of top_Pixel_Capture_0_0 is
...
U0: entity work.top_Pixel_Capture_0_0_Pixel_Capture
     port map (
      bram_addr(16 downto 0) => bram_addr(16 downto 0),
