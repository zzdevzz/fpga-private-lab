...
architecture STRUCTURE of top_VGA_OutputFrame_Colo_0_0_VGA_OutputFrame_Colour is
  ...
  signal \vert_counter[6]_i_2_n_0\ : STD_LOGIC;
  signal \vert_counter[9]_i_2_n_0\ : STD_LOGIC;
  signal vert_counter_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of Hp_out_i_3 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \horiz_counter[6]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \vert_counter[1]_i_1\ : label is "soft_lutpair6";
...
\vert_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"DFFFFFFF20000000"
    )
        port map (
...
\vert_counter[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
