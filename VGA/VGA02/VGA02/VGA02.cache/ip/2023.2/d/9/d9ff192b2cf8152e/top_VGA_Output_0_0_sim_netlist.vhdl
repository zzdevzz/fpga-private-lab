...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output is
  port (
    ...
    Vsync : out STD_LOGIC;
    clk : in STD_LOGIC;
    bram_data : in STD_LOGIC_VECTOR ( 4 downto 0 )
  );
...
begin
  vgaBlue(3 downto 1) <= \^vgagreen\(2 downto 0);
  vgaBlue(0) <= \^vgablue\(0);
  vgaGreen(3 downto 0) <= \^vgagreen\(3 downto 0);
  vgaRed(3 downto 1) <= \^vgagreen\(2 downto 0);
  vgaRed(0) <= \^vgablue\(0);
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_VGA_Output
     port map (
      ...
      bram_data(4 downto 0) => bram_data(5 downto 1),
      clk => clk,
      vgaBlue(3 downto 1) => \^vgagreen\(2 downto 0),
      vgaBlue(0) => \^vgablue\(0),
