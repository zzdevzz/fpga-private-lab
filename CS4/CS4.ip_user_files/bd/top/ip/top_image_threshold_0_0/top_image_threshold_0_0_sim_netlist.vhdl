...
--               Project/CS4/CS4.gen/sources_1/bd/top/ip/top_image_threshold_0_0/top_image_threshold_0_0_sim_netlist.vhdl}
...
entity top_image_threshold_0_0_image_threshold is
  port (
  ...
  attribute ORIG_REF_NAME of top_image_threshold_0_0_image_threshold : entity is "image_threshold";
end top_image_threshold_0_0_image_threshold;

architecture STRUCTURE of top_image_threshold_0_0_image_threshold is
...
\ram_out_din[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BAAA"
    )
        port map (
...
\ram_out_din[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55555557"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_image_threshold_0_0 is
  port (
    clk : in STD_LOGIC;
    load_done : in STD_LOGIC;
    threshold_done : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of top_image_threshold_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_image_threshold_0_0 : entity is "top_image_threshold_0_0,image_threshold,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of top_image_threshold_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of top_image_threshold_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of top_image_threshold_0_0 : entity is "image_threshold,Vivado 2023.2";
end top_image_threshold_0_0;

architecture STRUCTURE of top_image_threshold_0_0 is
...
begin
  ...
  ram_out_we <= \^ram_out_we\;
U0: entity work.top_image_threshold_0_0_image_threshold
     port map (
      clk => clk,
      load_done => load_done,
      ram_in_dout(7 downto 0) => ram_in_dout(7 downto 0),
      ram_out_addr(9 downto 0) => \^ram_out_addr\(9 downto 0),
      ram_out_din(0) => \^ram_out_din\(0),
      ram_out_we => \^ram_out_we\,
      threshold_done => threshold_done
